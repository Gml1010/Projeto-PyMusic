...
Siga o passo a passo abaixo para rodar o PyMusic localmente:

### 1. Clone o repositório
Abra o seu terminal e clone o projeto:
```bash
git clone [https://github.com/Gml1010/musicas-pymusic.git](https://github.com/Gml1010/musicas-pymusic.git)
cd musicas-pymusic
